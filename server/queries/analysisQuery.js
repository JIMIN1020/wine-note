...
exports.getTypes = `SELECT wine.type FROM review LEFT JOIN wine ON review.wine_id = wine.id WHERE user_id = ?`;
exports.getCountries = `SELECT wine.country FROM review LEFT JOIN wine ON review.wine_id = wine.id WHERE user_id = ?`;
