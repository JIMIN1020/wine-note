...
// 리뷰 전체 조회 쿼리
exports.getAllReviews = `SELECT wine.name, wine.country, wine.region, wine.img, wine.vintage, review.rating FROM review LEFT JOIN wine ON wine.id = review.wine_id WHERE user_id = ?`;
